...
# Lekin hum jab bhi ek list variable pe type function ka use karenge, toh humesha uska type list dikhayega. 
# Lekin list ke andar kuch bhi type ho sakte hain.

# Exercises
# Aap apne friends ki ek list banaye
friends=["myself","mom","aarti","sandesh"]

# Aap aap jin jin countries ko visit karna chahte hai unki ek list banaye
countries=["US","America","Dubai","Finland"]

# Aap peechle 5 mahine ke total expenses kitne hue, uski ek list banaye 
# (jaise maan lo, peechle mahine 58750 ke expenses hue, and so on)
expenditure=["january=2000","february=4657","march=6387","april=234","may=3453"]