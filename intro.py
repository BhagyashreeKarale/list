# Lists kya hota hai?
# Aapne string, integer, float aur booleans data types ke baarein mei padha hoga. 
# Yeh primitive data types kehlaye jaate hai. 
# Primitive ka yaha matlab hai simple data types, 
# jinka use kar kar hum aur complex data types bana sakte hai.
...
wishlist=["peace","mom smiling","dad proud","no regrets"]
